...
#symbols = ['MU', 'XLI', 'LCID', 'GS', 'INTC', 'F', 'PYPL', 'BAC', 'GDX', 'EWY', 'PEP', 'KO', 'GOOGL']
#symbols = ['UBER', 'TSLA', 'PINS', 'RBLX', 'SBUX', 'DIS', 'WMT', 'QCOM', 'IBM', 'SPOT', 'ADBE']
symbols = ['META', 'MMM', 'AMZN', 'NKE', 'MSFT', 'BA', 'AZN', 'MCD', 'NVDA', 'AMD', 'CPNG'] # 종목 리스트
cost = 0.01 # 매매 수수료
rf_rate = 0.028 # 무위험 이자율

print("\n_______________________________________\n")

for symbol in symbols: # 각 종목에 대해 백테스팅
    df = fs.get_price(symbol, start_date='2025-01-01', end_date='2025-07-18') # 날짜 범위에 대한 종목의 주가 가져오기
    #print(df.tail())
